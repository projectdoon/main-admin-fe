...
function Holder({ title, number, url, colour }) {
  return (
    <div className="min-w-52 h-[18vh] my-2">
      <Link
        to={url}
        className={`pt-3 pb-6 px-3 w-[100%] h-[100%] bg-white rounded-2xl border-2 shadow-md flex flex-col items-start justify-start`}
